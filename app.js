...
function changerules() {
  if (versionAdjust % 2 == 0) {
    document.querySelector("#rules>img").src = "./images/newrules.jpg";
  } else {
    document.querySelector("#rules>img").src = "./images/oldrules.png";
  }
}
...
function score_update(op1, op2) {
  switch (op1 + op2) {
    ...
    case "ScissorRock":
      lose();
      write_result.innerText = "YOU LOSE!";
      break;
    default:
...
function image_dispay(player, imageChosen) {
  document.querySelector("#" + player + ">img").src =
    "./images/" + imageChosen + ".png";
}

function refresh() {
  document.querySelector("#userChoice>img").src = "./images/userStart.gif";
  document.querySelector("#compChoice>img").src = "./images/compStart.gif";
  userSc = 0;
  compSc = 0;
  compScore.innerText = compSc;
  userScore.innerText = userSc;
